        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input 
              ...
              className="w-full bg-bg-tertiary border border-border rounded-lg px-4 py-2 text-text-primary focus:outline-none focus:border-accent-blue"
          ...
          <button 
            type="submit"
            className="w-full bg-accent-blue hover:bg-accent-blue/90 text-white font-medium py-2 rounded-lg transition-colors mt-4"
          >
            Sign In with Email
          </button>
        </form>
