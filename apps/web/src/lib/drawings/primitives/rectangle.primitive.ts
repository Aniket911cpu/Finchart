...
class RectRenderer implements ISeriesPrimitivePaneRenderer {
  ...
  constructor(series: ISeriesApi<any>, p1: Point | null, p2: Point | null, options: RectOptions) {
    this._series = series;
    this._p1 = p1;
    this._p2 = p2;
...
class RectPaneView implements ISeriesPrimitivePaneView {
  ...
  renderer(): ISeriesPrimitivePaneRenderer | null {
    return new RectRenderer(this._series, this._p1, this._p2, this._options);
  }
}
...
export class RectanglePrimitive implements ISeriesPrimitive {
  ...
  paneViews() {
    ...
    return [new RectPaneView(this._series, this._p1, this._p2, this._options)];
  }
