...
export default function ExplorePage() {
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-bg-primary p-6 md:p-10 text-text-primary">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {trending.map((item, i) => (
                <div 
                  ...
                  className="bg-bg-secondary border border-border hover:border-accent-blue/50 p-4 rounded-xl cursor-pointer transition-colors group"
                >
                  ...
                  {movers.map((item, i) => (
                    <tr key={i} className="hover:bg-bg-tertiary/50 transition-colors">
                      ...
                      <td className="p-4 text-center">
                        <button 
                          onClick={() => openChart(item.symbol)}
                          className="text-accent-blue hover:text-accent-blue-hover p-2 rounded-lg hover:bg-accent-blue/10 transition-colors"
                        >
                          <ArrowRight size={16} />
                        </button>
                      </td>
          ...
          <div className="space-y-4">
            {news.map((item) => (
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="block bg-bg-secondary border border-border hover:border-accent-blue/30 p-5 rounded-xl transition-colors"
              >
