...
export const chartSummary = async (
  req: FastifyRequest<{ Body: { symbol: string; timeframe: string; context?: string } }>,
  reply: FastifyReply
) => {
...
export const aiAsk = async (
  req: FastifyRequest<{ Body: { question: string; symbol?: string; chartContext?: string } }>,
  reply: FastifyReply
) => {
...
export const detectPatterns = async (
  req: FastifyRequest<{ Body: { symbol: string; timeframe: string } }>,
  reply: FastifyReply
) => {
