export const getMarketStats = async (req, reply) => {
...
export const getTrendingSymbols = async (req, reply) => {
...
export const getTopMovers = async (req, reply) => {
...
export const getNewsFeed = async (req, reply) => {
    // Mock news feed
    const news = [
...
//# sourceMappingURL=market-overview.controller.js.map